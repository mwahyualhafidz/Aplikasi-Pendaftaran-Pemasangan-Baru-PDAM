            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">Ubah Informasi / Berita</h4>
                    </div>
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <td>
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="tanggal_berita" value="<?php echo date("d-m-Y"); ?>" readonly>
                                            </div><br>
                                            <div>
                                                <label for="judul_berita" style="font-weight: bold;">Judul</label>
                                                <input type="text" class="form-control form-control-sm" name="judul_berita" value="<?= $berita["judul_berita"]; ?>" id="nama_pelanggan" autocomplete="off" required>
                                            </div><br>
                                            <div>
                                                <label for="gambar_berita" style="font-weight: bold;">Gambar Berita</label><br>
                                                <img src="../pdam/assets/img/berita/<?= $berita['gambar_berita']; ?>" width="350"><br><br>
                                                <input type="file" class="form-control form-control-sm" name="gambar_berita" id="gambar_berita">
                                            </div><br>
                                            <div>
                                                <label for="isi_berita" style="font-weight: bold;">Isi</label>
                                                <textarea name="isi_berita" id="isi_berita"><?= $berita['isi_berita']; ?></textarea>
                                            </div><br>
                                            <div>
                                                <label for="sumber_berita" style="font-weight: bold;">Sumber</label>
                                                <input type="text" class="form-control form-control-sm" name="sumber_berita" value="<?= $berita["sumber_berita"]; ?>" id="sumber_berita" autocomplete="off" required>
                                            </div><br><br>
                                            <div class="card-action">
                                                <center>
                                                    <button class="btn btn-success" type="submit" name="submit" onclick="return confirm('Anda yakin ingin mengubah berita ini?');">Ubah</button>
