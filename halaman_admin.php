			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Unit Pelayanan PDAM Karang Anyar</h4>
					</div>
					<marquee>
						<p>Selamat Datang Admin. Dimohon Bijaksana Dalam Penggunaan Akses Ini.</p>
					</marquee>
				</div>
				<div>
					<center><img src="assets/img/logo-pdam.png" width="300px" style="opacity: 0.1;"></center>
				</div>
			</div>
