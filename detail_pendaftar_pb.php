...
//query data pendaftar berdasarkan id
$pendaftar = query("SELECT * FROM pendaftar_pb WHERE id = $id")[0];
            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">Detail Data Pendaftar</h4>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <table cellpadding="30" width="920px">
                                <tr>
                                    <td width="460px">
                                        <h5 style="font-weight: bold;">DATA CALON PELANGGAN</h5><br>
                                        <h5 style="font-weight: bold;">Foto KTP :</h5>
                                        <img src="assets/img/ktp/<?= $pendaftar["ktp"] ?>" width="350"><br><br>
                                        <h5 style="font-weight: bold;">Nama :</h5>
                                        <h5><?= $pendaftar["nama"] ?></h5><br>
                                        <h5 style="font-weight: bold;">No. KTP :</h5>
                                        <h5><?= $pendaftar["no_ktp"] ?></h5><br>
                                        <h5 style="font-weight: bold;">Pekerjaan :</h5>
                                        <h5><?= $pendaftar["pekerjaan"] ?></h5><br>
                                        <h5 style="font-weight: bold;">Alamat :</h5>
                                        <h5><?= $pendaftar["alamat"] ?></h5><br>
                                        <h5 style="font-weight: bold;">No. HP :</h5>
                                        <h5><?= $pendaftar["no_hp"] ?></h5><br>
                                        <h5 style="font-weight: bold;">Jumlah Penghuni :</h5>
                                        <h5><?= $pendaftar["jumlah_huni"] ?></h5>
                                    </td>
                                    <td class="fa fa-align-top" aria-hidden="true" width="460px">
                                        <h5 style="font-weight: bold;">DATA PEMOHON</h5><br>
                                        <h5 style="font-weight: bold;">Tanggal Registrasi :</h5>
                                        <h5><?= $pendaftar["tanggal"] ?></h5><br>
                                        <h5 style="font-weight: bold;">No. Registrasi :</h5>
                                        <h5><?= $pendaftar["id"] ?></h5><br>
                                        <h5 style="font-weight: bold;">Nama :</h5>
                                        <h5><?= $pendaftar["nama_pemohon"] ?></h5><br>
                                        <h5 style="font-weight: bold;">Alamat :</h5>
                                        <h5><?= $pendaftar["alamat_pemohon"] ?></h5><br>
                                        <h5 style="font-weight: bold;">No. HP :</h5>
                                        <h5><?= $pendaftar["no_hp_pemohon"] ?></h5>
                                    </td>
                                </tr>
                            </table>
                            <div class="card-action">
                                <center><a href="pendaftar_pb.php" class="btn btn-primary">Kembali</a></center>
                            </div>
                        </div>
                    </div>
                </div>
