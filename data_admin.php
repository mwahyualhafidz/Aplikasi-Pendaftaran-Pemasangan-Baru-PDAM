...
$pdam = query("SELECT * FROM tb_admin LIMIT $awalData, $jumlahDataPerHalaman");

//tombol cari ditekan
if (isset($_POST["cari"])) {
    $pdam = cari_admin($_POST["keyword"]);
}
?>
        ...
        <div class="main-panel">
            <div class="content">
                <div class="page-inner">
                    ...
                    <div>
                        <a href="tambah_admin.php" class="btn-sm btn-light" data-bs-toggle="tooltip" title="Tambah">
                    ...
                    <table class="table table-head">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="hapus_admin.php?id=<?= $row["id"]; ?>" class="btn-sm btn-danger" data-bs-toggle="tooltip" title="Hapus" onclick="return confirm('Anda yakin ingin menghapus admin ini?');">
