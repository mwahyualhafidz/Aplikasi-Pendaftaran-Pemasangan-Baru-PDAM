...
$jumlahData = count(query("SELECT * FROM pelanggan_pb"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman); //ceil untuk membulatkan bilangan ke atas
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerHalaman * $halamanAktif) - $jumlahDataPerHalaman;

$pdam = query("SELECT * FROM pelanggan_pb LIMIT $awalData, $jumlahDataPerHalaman");

//tombol cari ditekan
if (isset($_POST["cari"])) {
    $pdam = cari_pelanggan_pb($_POST["keyword"]);
}
?>
                ...
                <div class="page-inner">
                    ...
                    <table class="table table-head">
                        ...
                        <tbody>
                            <tr>
                                <td><?= $i; ?></td>
                                <td><?= $row["tanggal_pelanggan"]; ?></td>
                                <td><?= $row["nama_pelanggan"]; ?></td>
                                <td><?= $row["no_hp_pelanggan"]; ?></td>
                                <td>
                                    <center>
                                        <a href="cetak_pelanggan_pb.php?id_pelanggan=<?= $row["id_pelanggan"]; ?>" class="btn-sm btn-success" data-bs-toggle="tooltip" title="Cetak" style="text-decoration: none;" target="_blank">
                                            <img src="assets/img/printer-fill.svg" width="15px">
                                        </a><br><br>
                                        <a href="ubah_pelanggan_pb.php?id_pelanggan=<?= $row["id_pelanggan"]; ?>" class="btn-sm btn-warning" data-bs-toggle="tooltip" title="Ubah" style="text-decoration: none;">
                                            <img src="assets/img/pen-fill.svg" width="15px">
                                        </a><br><br>
                                        <a href="hapus_pelanggan_pb.php?id_pelanggan=<?= $row["id_pelanggan"]; ?>" class="btn-sm btn-danger" data-bs-toggle="tooltip" title="Hapus" style="text-decoration: none;" onclick="return confirm('Anda yakin ingin menghapus data ini?');">
                                            <img src="assets/img/trash-fill.svg" width="15px">
                                        </a><br><br>
                                        <a href="detail_pelanggan_pb.php?id_pelanggan=<?= $row["id_pelanggan"]; ?>" class="btn-sm btn-info" data-bs-toggle="tooltip" title="Detail" style="text-decoration: none;">
