                                    ...
                                    <td>
                                        <form action="" method="post">
                                            <div>
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="nama" id="nama" autocomplete="off" required>
                                            </div><br>
                                            <div>
                                                <label for="username" style="font-weight: bold;">Username</label>
                                                <input type="text" class="form-control form-control-sm" name="username" id="username" autocomplete="off" required>
                                            </div><br>
                                            <div>
                                                <label for="password" style="font-weight: bold;">Password</label>
                                                <input type="password" class="form-control form-control-sm" name="password" id="password" autocomplete="off" required>
                                            </div><br>
                                            <div>
                                                <label for="password2" style="font-weight: bold;">Konfirmasi Password</label><br>
                                                <input type="password" class="form-control form-control-sm" name="password2" id="password2" autocomplete="off" required>
                                            </div><br><br>
                                            <div class="card-action">
                                                <center>
                                                    <button class="btn btn-success" type="submit" name="register">Tambah</button>
