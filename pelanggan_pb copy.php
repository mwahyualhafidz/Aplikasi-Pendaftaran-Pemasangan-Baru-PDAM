                    ...
                    <table class="table table-head">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="cetak_pelanggan_pb.php?id_pelanggan=<?= $row["id_pelanggan"]; ?>" class="btn-sm btn-success" style="text-decoration: none;" target="_blank">
                                            <img src="assets/img/printer-fill.svg" width="15px">
                                        </a><br><br>
                                        <a href="ubah_pelanggan_pb.php?id_pelanggan=<?= $row["id_pelanggan"]; ?>" class="btn-sm btn-warning" style="text-decoration: none;">
                                            <img src="assets/img/pen-fill.svg" width="15px">
                                        </a><br><br>
                                        <a href="hapus_pelanggan_pb.php?id_pelanggan=<?= $row["id_pelanggan"]; ?>" class="btn-sm btn-danger" style="text-decoration: none;" onclick="return confirm('Anda yakin ingin menghapus data ini?');">
                                            <img src="assets/img/trash-fill.svg" width="15px">
                                        </a><br><br>
                                        <a href="detail_pelanggan_pb.php?id_pelanggan=<?= $row["id_pelanggan"]; ?>" class="btn-sm btn-info" style="text-decoration: none;">
