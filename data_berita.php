...
$pdam = query("SELECT * FROM berita LIMIT $awalData, $jumlahDataPerHalaman");

//tombol cari ditekan
if (isset($_POST["cari"])) {
    $pdam = cari_berita($_POST["keyword"]);
}
?>
        ...
        <div class="main-panel">
            <div class="content">
                <div class="page-inner">
                    ...
                    <div>
                        <a href="tambah_berita.php" class="btn-sm btn-light" data-bs-toggle="tooltip" title="Tambah">
                            <img src="assets/img/plus-square-fill.svg" width="15px">
                        </a>
                    </div><br>
                    ...
                    <table class="table table-head">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?= $row["sumber_berita"]; ?></td>
                                <td>
                                    <center>
                                        <a href="ubah_berita.php?id=<?= $row["id"]; ?>" class="btn-sm btn-warning" data-bs-toggle="tooltip" title="Ubah">
                                            <img src="assets/img/pen-fill.svg" width="15px">
                                        </a><br><br>
                                        <a href="hapus_berita.php?id=<?= $row["id"]; ?>" class="btn-sm btn-danger" data-bs-toggle="tooltip" title="Hapus" onclick="return confirm('Anda yakin ingin menghapus berita ini?');">
